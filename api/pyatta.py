...
from firewall_service import zoneMainSetup, zoneServices
#initialization
...
api.add_resource(zoneMainSetup,'/v1.0/services/firewall/zone')
api.add_resource(zoneServices,'/v1.0/services/firewall/zone/<zone_name>')
